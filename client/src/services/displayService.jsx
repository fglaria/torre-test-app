...
export const showUser = (info) => {
  ...
  return (
    <div class="mt-3 mb-5">
      <img src={ info.person.pictureThumbnail } alt='' rounded="true"></img>
...
export const showJob = (info) => {
  console.log(info);
  const job = jobExtractDetails(info.details);

  return (
    <div class="mt-3 mb-5">
      {
        info.organizations.map((o, index) => 
          <Col key={ index }>
...
const jobExtractDetails = (details) => {
  let job = {"benefits": []};
